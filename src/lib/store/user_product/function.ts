...
import {user_product_modal_state,user_product_form_state} from './state';
...
user_product_modal_state.subscribe((data) => {
    update_modal = data;
})

user_product_form_state.subscribe((data) => {
    update_form = data;
})
...
const userProductModalOpen = () => {
  ...
  console.log('누름');
    ...
    user_product_modal_state.update(() => update_modal);
    ...
    let filtered_user_data = user_data.filter(item => {
      return user_uid === item.id; 
        ...
        Object.keys(update_form).map((item)=> {    
            ...
            user_product_form_state.update(() => update_form);
            user_product_modal_state.update(() => update_modal);
    ...
    if(title === 'update'){
      ...
      axios.post(url,
        ...
        if(res.data !== undefined && res.data !== null && res.data !== '' ){
          ...
          user_product_modal_state.update(() => update_modal);
          user_product_form_state.update(()=> init_form_data);
...
export {userProductModalOpen,save,userProductTable,modalClose}