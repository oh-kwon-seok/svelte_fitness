...
<script>
    ...
    onMount(()=>{
      ...
      selectCardQuery('user_order_sub','mobile_buy_select');
    ...
    afterUpdate(()=> {
        ...
        }else if($url_state['path'] === '/user_buy_product'){
        ...
        <Card img={food_url}  class="mb-4 h-screen text-center">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">자주 구매한 상품</h5>
          <SearchBar title="user_order_sub" label="구매일자"/>    
