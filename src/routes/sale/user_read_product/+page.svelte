...
<script>
    ...
    afterUpdate(()=> {
        ...
        }else if($url_state['path'] === '/user_read_product'){
        ...
        <Card img={food_url}  class="mb-4 h-screen text-center">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">최근 본 상품</h5>
          <SearchBar title="user_order_sub" label="검색일자"/>    
